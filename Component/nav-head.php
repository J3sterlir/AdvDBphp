...
?>
    <nav id="sidebar">
            <ul>
                ...
                <li class="activestattrk">
                    <a href="filestattrk.php">
                        ...
                        <span>File Status Tracker</span>
                    </a>
                </li>

                <li class="activeclients">
                    <a href="clients.php">
                ...
                <li>
                    <form action="Profile.php" method="post" id="logoutform" class="formbutton">
